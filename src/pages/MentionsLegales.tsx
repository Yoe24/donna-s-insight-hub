        ...
        <main className="flex-1 max-w-2xl mx-auto px-6 py-16 font-sans">
          ...
          <div className="space-y-8 text-sm text-muted-foreground leading-relaxed">
            <section>
              ...
              <p>Donna-Legal.ai — [Adresse à compléter]</p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2">
                Pour exercer ces droits, vous pouvez nous contacter à l'adresse : contact@donna-legale.ai
              </p>
              <p className="mt-2">
