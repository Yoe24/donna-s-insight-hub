...
const DOSSIERS = [
  ...
  { id: "d5", initials: "AB", name: "Alice Bernard", type: "Droit de la famille", color: "#DC2626",
    summary: "Procédure de divorce par consentement mutuel. Convention en cours de rédaction. Points restants : partage du bien commun (appartement estimé 320 000€) + garde alternée des 2 enfants.",
