...
// ─── Palette Marine + Or — Prestige ───
const BG = "#FFFFFF"
const SIDEBAR_BG = "#F7F6F3"
const SIDEBAR_BORDER = "#E8E4DC"
const TEXT = "#1B2A4A"
const TEXT_MUTED = "#5A6A85"
const TEXT_LIGHT = "#8E99AB"
const ACCENT = "#1B2A4A"
const ACCENT_BG = "#F0EDE6"
const GOLD = "#C8A961"
...
const GREEN = "#2D6A4F"
const BORDER = "#E8E4DC"
const INITIALS_BG = "#1B2A4A"
const INITIALS_TEXT = "#C8A961"
      ...
      <div style={{ padding: "16px 20px" }}>
        ...
        <div style={{ marginTop: 12, marginLeft: 27 }}>
          <button
            ...
            style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "8px 16px", borderRadius: 7, border: "none", background: "#C8A961", color: "#1B2A4A", fontSize: 12, cursor: "pointer", fontFamily: "inherit", fontWeight: 600, boxShadow: "0 1px 4px rgba(200,169,97,0.25)" }}
          >
        ...
        {expanded && (
          ...
          >
            <div style={{ padding: "14px 20px 18px 20px", borderTop: `1px solid ${BORDER}` }}>
              ...
              <button
                onClick={e => { e.stopPropagation(); onDraft() }}
                style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 7, width: "100%", padding: "11px 18px", borderRadius: 8, background: GREEN, color: "#fff", border: "none", fontSize: 13, fontWeight: 600, cursor: "pointer", fontFamily: "inherit" }}
              >
  ...
  return (
    <>
      ...
      <div style={{ padding: "10px 14px", borderTop: `1px solid ${SIDEBAR_BORDER}` }}>
        <a href="https://calendly.com/contact-donna-legal/onboarding-15min" target="_blank" rel="noopener noreferrer" style={{ fontSize: 12, color: "#C8A961", fontWeight: 500, display: "flex", alignItems: "center", gap: 5, textDecoration: "none", marginBottom: 6 }}>
      ...
      <div style={{ flex: 1, display: "flex", overflow: "hidden", position: "relative" }}>
        ...
        {selectedDossier ? (
          ...
          <div style={{ maxWidth: isMobile ? "100%" : 900, margin: "0 auto", padding: isMobile ? "20px 16px" : "36px 44px" }}>
            ...
            <AnimatePresence>
              {animPhase >= 2 && (
                <motion.div key="donna-bloc" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} style={{ marginBottom: 20 }}>
                  <div style={{
              ...
              {visibleTaskCount > 0 && animPhase >= 2 && activeTab === "todo" && (
                <motion.div key="tasks" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }} style={{ marginBottom: 8 }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14, marginTop: 4 }}>
                    ...
                    <span style={{ fontSize: 11, fontWeight: 600, color: '#C8A961', textTransform: "uppercase", letterSpacing: 0.8, whiteSpace: "nowrap" }}>Tâches créées par Donna</span>
                    <div style={{ height: 1, flex: 1, background: BORDER }} />
                  </div>
            ...
            <AnimatePresence>
              {animDone && (
                ...
                >
                  ...
                  <a href="https://calendly.com/contact-donna-legal/onboarding-15min" target="_blank" rel="noopener noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: 7, padding: "11px 22px", borderRadius: 8, background: "#C8A961", color: "#1B2A4A", fontSize: 14, fontWeight: 700, textDecoration: "none", flexShrink: 0 }}>
