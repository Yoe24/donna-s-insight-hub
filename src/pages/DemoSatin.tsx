...
const URGENT = "#EA580C"
const URGENT_BG = "#FFF7ED"
const GREEN = "#16A34A"
const BORDER = "#E2E8F0"
const INITIALS_BG = "#4361EE"
      ...
      <div style={{ padding: "16px 20px" }}>
        ...
        <div style={{ marginTop: 12, marginLeft: 27 }}>
          <button
            ...
            style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "8px 16px", borderRadius: 7, border: "none", background: "#4361EE", color: "#fff", fontSize: 12, cursor: "pointer", fontFamily: "inherit", fontWeight: 600, boxShadow: "0 1px 4px rgba(67,97,238,0.25)" }}
          >
            ...
            <AnimatePresence>
              {animDone && (
                ...
                >
                  ...
                  <a href="https://calendly.com/contact-donna-legal/onboarding-15min" target="_blank" rel="noopener noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: 7, padding: "11px 22px", borderRadius: 8, background: "#F59E0B", color: "#1E293B", fontSize: 14, fontWeight: 700, textDecoration: "none", flexShrink: 0 }}>
